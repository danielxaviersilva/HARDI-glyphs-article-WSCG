...
\centering
\captionsetup[subfloat]{farskip=0pt,nearskip=0pt}
    \subfloat[General rendering scheme for ODFs benchmark ]{\includegraphics[width=1.\linewidth, angle=0]{figs/Benchmark/benchmark_full.png}
    \label{fig::benchmark_full}
    }
    \\
    \subfloat[Optimized rendering scheme for symmetrical ODFs benchmark ]{\includegraphics[width=1.\linewidth, angle=0]{figs/Benchmark/benchmark_half.png}
    \label{fig::benchmark_half}
    }
    \\
     \caption{Glyph rendering FPS vs number of glyphs being rendered. The blue, orange and green curves correspond to a spherical mesh of 162, 642, 2462 vertices respectively. These meshes are generated by $4^{th}$, $8^{th}$ and $16^{th}$ order tessellation of the icosahedron} %!!VER SE ISSO TA CERTO
    \label{fig::benchmark}
\end{figure}
