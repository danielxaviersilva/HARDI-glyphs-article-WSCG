...
\begin{figure}[h]
    ...
    \caption{Glyphs integrated into a DW-MRI's visualization scheme. The region shows the midsection of a axial region of the brain, with a plane cutting in the left side%. The spherical mesh used corresponds to an 8-th tessellated icosahedron
    }
