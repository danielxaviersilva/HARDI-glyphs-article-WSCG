...
%2nd line of address\\
Brazil\\[1mm]
danielxaviers@gmail.com
}
\hspace{0.05\textwidth}
\parbox{0.25\textwidth}{\centering
Raphael Voltoline\\[1mm]
DCA/FEEC/University of Campinas,\\
%1st line of address\\
%2nd line of address\\
Brazil\\[1mm]
raphavoltoline.rvr@gmail.com
}
\hspace{0.05\textwidth}
\parbox{0.25\textwidth}{\centering
Wu Shin-Ting\\[1mm]
...
We measured the time performance in FPS of the multimodal rendering for ODF. The number of glyphs is changed through the viewing scaling factor. The greater is the zoom factor, the smaller is the number of glyphs, the higher is each glyph's voxel screen occupancy, increasing their resolution. The output image's resolution is 850x850, and the number of visible glyphs varies between 12 and 13360. The glyphs' resolution varies from the $2^{nd}$ (the lowest level of detail, Figure \ref{fig::multimodal_lowres}) to the $8^{th}$ (the highest level of detail, Figure \ref{fig::multimodal_highres}) tessellation order of the icosahedron. The FPS of the rendering scheme, alongside the number of visible glyphs rendered, the base geometry used, and their respective scaling factors, are listed in Table \ref{tab::glyph_info_experiment}, where we attest that the scheme renders at interactive rates.
...
\hline
\end{tabular}
\caption{Glyph Information in image 850 x 850. The number of vertices and triangles of the base geometry used is in Table \ref{tab::icosahedron_set}.}
...
%DO WE MENTION THE GPU CACHE USE BY SENDING DATA IN SEQUENCE?
